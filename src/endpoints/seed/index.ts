...
export const seed = async ({
  ...
  await payload.create({
    ...
    data: {
      name: 'Editor',
      description: 'Can create and edit Pages, Posts, and Media. Cannot manage Users or Roles.',
      accessAdmin: true,
      isAdminRole: false,
      permissions: [
        { collection: 'pages', create: true, read: true, update: true, delete: false },
        { collection: 'posts', create: true, read: true, update: true, delete: false },
        { collection: 'media', create: true, read: true, update: true, delete: false },
      ],
    },
  })
